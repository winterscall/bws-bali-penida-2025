  ...
  <nav aria-label="breadcrumb" class="layout-navbar-user navbar-nav align-items-center ms-0 ms-md-3 me-3 me-xl-0">
    <ol class="breadcrumb breadcrumb-style1 mb-0">
      <li class="breadcrumb-item">
        <a href="{{ route('backpanel.news_types.index') }}">Tipe Berita</a>
      </li>
      <li class="breadcrumb-item active">Tambah Tipe Berita</li>
    </ol>
  </nav>
@endsection
      ...
      <div class="col-md-6">
        <div class="card mb-6">
          <div class="card-header header-elements">
            <h5 class="mb-0 me-2">Tambah Tipe Berita</h5>
          </div>
          <div class="card-body">
            <form action="{{ route('backpanel.news_types.store') }}" method="POST">
              @csrf
              <div class="mb-4">
