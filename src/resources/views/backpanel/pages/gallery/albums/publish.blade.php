  ...
  <nav aria-label="breadcrumb" class="layout-navbar-user navbar-nav align-items-center ms-0 ms-md-3 me-3 me-xl-0">
    <ol class="breadcrumb breadcrumb-style1 mb-0">
      <li class="breadcrumb-item">
        <a href="{{ route('backpanel.albums.index') }}">Albums</a>
      </li>
      <li class="breadcrumb-item">
        <a href="{{ route('backpanel.albums.show', ['album' => $album]) }}">Detail Album</a>
      </li>
      <li class="breadcrumb-item active">Publish Album</li>
    </ol>
  </nav>
@endsection
      ...
      <div class="col-md-12">
        <div class="card mb-6">
          <div class="card-header header-elements">
            <h5 class="mb-0 me-2">Publish Album</h5>
          </div>
          <div class="card-body">
            <form id="form" action="{{ route('backpanel.albums.update_publish', ['album' => $album]) }}" method="POST">
              @csrf @method('PUT')
              <div class="mb-4">
