...
@section('page_title')
  Tambah Postingan Media Digital
@endsection
...
@section('breadcrumb')
  <nav aria-label="breadcrumb" class="layout-navbar-user navbar-nav align-items-center ms-0 ms-md-3 me-3 me-xl-0">
    <ol class="breadcrumb breadcrumb-style1 mb-0">
      ...
      <li class="breadcrumb-item active">Tambah Postingan Media Digital</li>
    </ol>
  </nav>
@endsection
      ...
      <div class="col-md-6">
        <div class="card mb-6">
          <div class="card-header header-elements">
            <h5 class="mb-0 me-2">Tambah Postingan Media Digital</h5>
          </div>
          <div class="card-body">
            <form action="{{ route('backpanel.media.digital.store') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="mb-4">
              ...
              <div class="mb-4">
                <label for="cover_file" class="form-label">Cover File <span class="text-danger">*</span></label>
                <input type="file" class="form-control @error('cover_file') is-invalid @enderror" id="cover_file"
                  name="cover_file" required />
                @error('cover_file')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="mb-4">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="media_type" id="media_type_none" value="none" checked>
                  <label class="form-check-label" for="media_type_none">
                    Tidak Ada
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="media_type" id="media_type_attachment" value="attachment">
                  <label class="form-check-label" for="media_type_attachment">
                    File Attachment
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="media_type" id="media_type_url" value="url">
              ...
              <div class="mb-4" id="attachment_field" style="display: none;">
                <label for="attachment_file" class="form-label">File Dokumen <span class="text-danger">*</span></label>
              ...
              <div class="mb-4" id="url_field" style="display: none;">
                ...
                <input type="url" class="form-control @error('media_url') is-invalid @enderror" id="media_url"
                  name="media_url" value="{{ old('media_url') }}" placeholder="https://example.com" />
                @error('media_url')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
