...
<script src="{{ asset('bp-assets/vendor/libs/i18n/i18n.js')}}"></script>
<script src="{{ asset('bp-assets/vendor/libs/typeahead-js/typeahead.js')}}"></script>
<script src="{{ asset('bp-assets/vendor/js/menu.js')}}"></script>

<!-- endbuild -->

<!-- Vendors JS -->
<script src="{{ asset('bp-assets/vendor/libs/@form-validation/popular.js')}}"></script>
<script src="{{ asset('bp-assets/vendor/libs/@form-validation/bootstrap5.js')}}"></script>
<script src="{{ asset('bp-assets/vendor/libs/@form-validation/auto-focus.js')}}"></script>
